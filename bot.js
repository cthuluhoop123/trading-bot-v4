                ...
                await backpacktf.createListings([
                    {
                        ...
                        details: `⚡[⇄] 24/7 TRADING BOT! // Send me a trade offer!⚡ Buying for: ${prices[item].buy.keys} key(s) + ${scrapToRef(prices[item].buy.metal)} ref! Stock: ${inInventory}/${prices[item].stock}! // 1 key = ${keyPrice} refs.`,
                        currencies: {
